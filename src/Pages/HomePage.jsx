        ...
        <div className="AboutPage">
         <Tittle title={'About Me'} span={'About Me'} />
            ...
            <header className="hero">
                <div className="icons">
                    <a href="https://www.linkedin.com/in/rudrakshi-soni-403031195/" className="icon-holder">
                    ...
                    <a href="https://stackoverflow.com/users/12773738/rudrakshi?tab=profile" className="icon-holder">
